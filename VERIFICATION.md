# Verification plan — Dying Light: The Beast

Status: NOT RUN. There is no executable implementation to test.

## Module acceptance criteria

### 1. Story loadout scenarios

- [ ] Define a versioned input fixture specifically for story loadout scenarios.
...
### 2. Consumable budget sheets

- [ ] Define a versioned input fixture specifically for consumable budget sheets.
- [ ] Document the expected output and units before implementation.
- [ ] Test valid, missing, malformed, and unsupported-version inputs.
- [ ] Repeat with the same fixture and compare results.
- [ ] Confirm that source files and unrelated settings remain unchanged.

### 3. Progress checkpoint register

- [ ] Define a versioned input fixture specifically for progress checkpoint register.
- [ ] Document the expected output and units before implementation.
- [ ] Test valid, missing, malformed, and unsupported-version inputs.
- [ ] Repeat with the same fixture and compare results.
- [ ] Confirm that source files and unrelated settings remain unchanged.
