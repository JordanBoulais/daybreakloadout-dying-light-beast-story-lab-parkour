...
<div align="center">
  <img src="./public/logo.svg" alt="DaybreakLoadout — Dying Light: The Beast — Parkour" width="64" height="64">
  <h1>DaybreakLoadout — Dying Light: The Beast — Parkour</h1>
</div>

An independent project specification for Dying Light: The Beast, covering story loadout scenarios, consumable budget sheets, progress checkpoint register.
...
<img src="./public/screenshots/desktop-main.svg" alt="Dying Light: The Beast — desktop concept, not a screenshot" width="520">
<br>
<em>Three proposed modules, not implemented features</em>
</td>
<td align="center">
<h3>Compact Concept</h3>
<img src="./public/screenshots/mobile-overview.svg" alt="Dying Light: The Beast — compact concept, not a screenshot" width="250">
<br>
...
- **Story loadout scenarios** — planned module; not implemented.
- **Consumable budget sheets** — planned module; not implemented.
- **Progress checkpoint register** — planned module; not implemented.

The proposed workflow separates story loadout scenarios from consumable budget sheets, with progress checkpoint register retained for reproducibility. These are design goals, not claims about existing functionality.
...
3. Describe one baseline scenario for **Story loadout scenarios**.
...
<div align="center">
<img src="./public/screenshots/review-workflow.svg" width="700" alt="DaybreakLoadout — Dying Light: The Beast — Parkour — specification review workflow">
<br>
...
### Story loadout scenarios

Define the input and expected outcome for module 1. Record the Dying Light: The Beast version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Consumable budget sheets

Define the input and expected outcome for module 2. Record the Dying Light: The Beast version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### Progress checkpoint register

Define the input and expected outcome for module 3. Record the Dying Light: The Beast version, scenario conditions, and known limitations. Completing these notes manually does not establish that an automated tool exists.

### At a glance

| Field | Value |
|---|---|
| Target | Dying Light: The Beast |
| Category | Offline game project |
| Input | Manual notes or user-authorized local exports |
| Planned output | Story loadout scenarios |
