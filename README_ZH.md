...
独立的项目设计文档，适用对象： **Dying Light: The Beast**。
...
- **剧情配装场景** (Story loadout scenarios) — 规划模块，尚未实现。
- **消耗品预算表** (Consumable budget sheets) — 规划模块，尚未实现。
- **进度检查点记录** (Progress checkpoint register) — 规划模块，尚未实现。
